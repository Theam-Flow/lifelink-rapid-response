  ...
  public: {
    Tables: {
      financial_aid: {
        Row: {
          ...
          total_reported_received: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "financial_aid_recipient_id_fkey"
          ...
          {
            foreignKeyName: "financial_aid_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      rescuer_activity: {
        ...
        Relationships: [
          {
            foreignKeyName: "rescuer_activity_current_sos_id_fkey"
            columns: ["current_sos_id"]
            isOneToOne: false
            referencedRelation: "sos_signals"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "rescuer_activity_rescuer_id_fkey"
            columns: ["rescuer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      shelter_activity_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "shelter_activity_logs_shelter_id_fkey"
            columns: ["shelter_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "shelter_activity_logs_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      shelter_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "shelter_alerts_resolved_by_fkey"
            columns: ["resolved_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shelter_alerts_shelter_id_fkey"
            columns: ["shelter_id"]
            isOneToOne: false
            referencedRelation: "shelters"
            referencedColumns: ["id"]
      ...
      shelters: {
        ...
        Relationships: [
          {
            foreignKeyName: "shelters_manager_id_fkey"
            columns: ["manager_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      sos_signals: {
        ...
        Relationships: [
          {
            foreignKeyName: "sos_signals_assigned_rescuer_id_fkey"
            columns: ["assigned_rescuer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "sos_signals_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      user_role:
        ...
        | "logistics"
        | "shelter_manager"
      user_status: "safe" | "danger" | "missing" | "deceased" | "unknown"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
